  ...
  return (
    <div style={mainDivStyle}>
      <div>
        ...
        {open && <CompareViewGraphOptions names={graph17names} open={open} handleClose={handleClose} handleDropdownChange={handleDropdownChange} selectedOption={selectedOption} mainOption={mainOption} onViewClick={onViewClick} onCompareClick={onCompareClick} />}
      </div>
      {
