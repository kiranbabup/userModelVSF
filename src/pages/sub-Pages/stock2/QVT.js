...
const QVT = ({ display, headingText, embedHTML }) => {
    ...
    //             data-get-url="https://trendlyne.com/web-widget/qvt-widget/Poppins/${embedCode}/?posCol=00A25B&primaryCol=006AFF&negCol=EB3B00&neuCol=F7941E" 
    //             data-theme="light">
    //         </blockquote>
    //     `);
    ...
    return (
        <Box style={containerBox}>
            <Typography style={headerTypo}>Quality.Value.Technicals</Typography>
            {/* <Box style={containerBox}>
                <TextField
                    type="text"
                    id="searchBar"
                ...
                {
                    (searchTerm.length === 0) &&
                    (<Typography style={centerBText}>Type to view Q.V.T of a stock.</Typography>)
                } */}
            {
                !display &&
                // display ?
